 ...
 * @param amount User input to withdraw specified amount
 * from balance
 */
...
/**
 * 
 * @param amount User input to deposit amount to their
 * account
 */
...
/**
 * Method to calculate the monthly interest of the given annual
 * interest rate
 * @return returns the monthly interest rate for a specified account
 * while taking the account balance and the annual interest rate set to it 
 */
